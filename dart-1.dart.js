...
Bz:[function(a){P.YF(C.R,a)},"$1","K7",2,0,11],
Cx:function(){var z,y
...
T9:[function(a){return J.v1(a)},"$1","rm",2,0,13,13],
...
return P.wY(H.kx(a,y))},null,null,8,0,null,14,15,16,17],
...
else return P.hE(a,"_$dart_jsObject",new P.Hp($.hs()))}},"$1","En",2,0,2,18],
...
else return P.ND(a)}},"$1","Xl",2,0,16,18],
...
r7:{
"^":"E4;Q",
static:{iO:function(a){return new P.r7(a)}}},
Tz:{
"^":"Wk;Q",
...
$.zi=v+1
J.C7(w,"count",v)
y.Z("render",[z.Z("createElement",[x,w]),document.getElementById("example-container")])
P.rT(C.R,V.S())},"$0","S",0,0,0],
Q:[function(){P.rT(C.R,V.S())},"$0","ao",0,0,0],
Mk:function(){return P.M($.O(),null)},
wJ:{
"^":"r:10;",
$1:[function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=H.J(new P.Tz([]),[null])
y=J.T(J.T(a,"props"),"count")
for(x=J.Qc(y),w=0;w<250;++w){v=x.g(y,w)
u=$.N()
t=J.T(J.T(u,"React"),"DOM")
s=$.O()
r=P.M(s,null)
q=J.Y(r)
q.q(r,"className","box-view")
q.q(r,"key",w)
u=J.T(J.T(u,"React"),"DOM")
q=P.M(s,null)
p=J.Y(q)
p.q(q,"className","box")
s=P.M(s,null)
...
n=o.S(v,10)
m=J.Y(s)
m.q(s,"top",Math.sin(n)*10)
n=o.S(v,10)
m.q(s,"left",Math.cos(n)*10)
m.q(s,"background","rgb(0, 0,"+H.d(o.V(v,255))+")")
p.q(q,"style",s)
s=[]
o=new H.A8([u.Z("div",[q,o.V(v,100)])],P.En())
o.$builtinTypeInfo=[null,null]
C.Nm.FV(s,o)
u=new P.Tz(s)
u.$builtinTypeInfo=[null]
z.Z("push",[t.Z("div",[r,u])])}return J.T(J.T($.N(),"React"),"DOM").Z("div",[null,z])},null,null,2,0,null,19,"call"]}},1],["","",,P,{
"^":""}],]
setupProgram(dart)
...
if(a instanceof P.a)return a
return J.ks(a)}
J.C0=function(a,b){return J.Y(a).ez(a,b)}
...
try{(void 0).$method$($argumentsExpr$)}catch(z){return z.message}}())},"BX","zO",function(){return H.cM(H.Mj(null))},"tt","Bi",function(){return H.cM(function(){try{null.$method$}catch(z){return z.message}}())},"dt","eA",function(){return H.cM(H.Mj(void 0))},"A7","ko",function(){return H.cM(function(){try{(void 0).$method$}catch(z){return z.message}}())},"lI","ej",function(){return P.xg()},"nM","Ex",function(){return[]},"L","N",function(){return P.ND(self)},"kt","Iq",function(){return H.Yg("_$dart_dartObject")},"Ri","Dp",function(){return H.Yg("_$dart_dartClosure")},"Je","hs",function(){return function DartObject(a){this.o=a}},"V","P",function(){var z,y
z=J.T($.N(),"React")
y=V.Mk()
J.C7(y,"render",P.iO(P.xZ(new V.wJ(),!0)))
return z.Z("createClass",[y])},"W","O",function(){return J.T($.N(),"Object")}])

init.metadata=["object","sender","e","x","closure","isolate","numberOfArguments","arg1","arg2","arg3","arg4","each","_","a","callback","captureThis","self","arguments","o","jsThis",];init.types=[{func:""},{func:"",void:true},{func:"",args:[,]},{func:"",args:[P.I,,]},{func:"",args:[,P.I]},{func:"",args:[P.I]},{func:"",args:[{func:"",void:true}]},{func:"",args:[,,]},{func:"",args:[P.wv,,]},{func:"",ret:P.I,args:[P.KN]},{func:"",args:[P.E4]},{func:"",void:true,args:[{func:"",void:true}]},{func:"",ret:P.a2,args:[,,]},{func:"",ret:P.KN,args:[,]},{func:"",ret:P.a2,args:[P.a,P.a]},{func:"",ret:P.KN,args:[P.a]},{func:"",ret:P.a,args:[,]},];$=null
...
if(typeof dartMainRunner==="function")dartMainRunner(function(b){H.Rq(V.ao(),b)},[])
else (function(b){H.Rq(V.ao(),b)})([])})
})()
